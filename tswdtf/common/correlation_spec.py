...
from tswdtf.common.correlation import Correlation, CrossCorrelation, AutoCorrelation
from tswdtf.tests import TestCase


class SimpleCorrelationSpec(TestCase):
    def setUp(self):
        self.sheets = self.read_ods(self.from_test_res("correlation.ods", __file__))
    ...
    def test_simple_correlation(self):
        ...
        np.testing.assert_almost_equal(output, s["Correlation"].values, decimal=6)
