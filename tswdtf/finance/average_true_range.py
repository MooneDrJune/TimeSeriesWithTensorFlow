...
class AverageTrueRange(Streamable):
    ...
    def step(
        self, close_price, low_price, high_price, last_close=None, last_rma_state=None
    ):
        ...
        atr, new_rma_state, rma_init_state = self.rma(
            tr, state=last_rma_state, streamable=False
        )
