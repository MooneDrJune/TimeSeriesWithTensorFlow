...
from tswdtf.finance.supertrend import Supertrend
...
class SupertrendSpec(TestCase):
    def setUp(self):
        self.sheets = self.read_ods(self.from_test_res("supertrend.ods", __file__))
    ...
    def test_supertrend(self):
        ...
        supertrend_ts, _, _ = supertrend(inputs=(close_prices, low_prices, high_prices))
        ...
        np.testing.assert_almost_equal(output, sheet["Supertrend"].values, decimal=3)
