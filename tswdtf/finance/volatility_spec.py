...
from tswdtf.finance.volatility import Volatility


class VolatilitySpec(TestCase):
    def setUp(self):
        self.sheets = self.read_ods(self.from_test_res("volatility.ods", __file__))
    ...
    def test_volatility(self):
        ...
        np.testing.assert_almost_equal(output, inputs["Volatility"].values, decimal=3)
