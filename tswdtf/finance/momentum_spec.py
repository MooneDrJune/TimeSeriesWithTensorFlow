...
from tswdtf.finance.momentum import Momentum
from tswdtf.tests import TestCase


class MomentumSpec(TestCase):
    def setUp(self):
        self.sheets = self.read_ods(self.from_test_res("momentum_5.ods", __file__))
    ...
    def test_momentum_single_dim(self):
        ...
        np.testing.assert_almost_equal(output, input_ts["Momentum"].values, decimal=3)
